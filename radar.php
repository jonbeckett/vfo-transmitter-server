    ...
    <div class="radar-container">
        <div class="radar-info">
            <div class="radar-stats">
                ...
                <div class="radar-links-toggle" onclick="document.getElementById('radar-links').classList.toggle('collapsed'); this.querySelector('i').classList.toggle('fa-chevron-down'); this.querySelector('i').classList.toggle('fa-chevron-up');">
                    <i class="fas fa-chevron-down"></i> Links
                </div>
                <div id="radar-links" class="radar-links collapsed">
